interface Props { id: string; color: string; size?: number }

export default function FeatureIcons({ id, color, size = 16 }: Props) {
  ...
  switch (id) {
    ...
    case 'products':
      return <svg {...props}><path d="M20 7H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>
    case 'events':
