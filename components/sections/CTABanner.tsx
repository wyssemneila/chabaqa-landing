...
export default function CTABanner() {
  ...
  return (
    <div className="mx-6 md:mx-10 my-16 rounded-3xl px-8 md:px-16 py-16 text-center reveal overflow-hidden relative" style={{ background: 'linear-gradient(135deg, var(--p), var(--p-dark))' }} role="complementary" aria-label="Call to action">
      {/* Decorative blobs */}
